		...
		<div className="container mx-auto max-w-4xl py-28 ">
			...
			<div className="prose dark:prose-dark">
				...
				<div className="prose dark:prose-dark">
					...
					<p>
						I’m primarily working with Javascript and Headless / Jamstack stack nowadays, but also have a
						lot of experience with custom theme development for Wordress , Shopify, etc...
					</p>
