...
export const Hero = () => (
	<section>
		<div className="container mx-auto max-w-7xl grid grid-cols-2 items-end gap-8">
			<div className="">
				<Image
			...
			<div className="">
				...
				<h1 className="text-6xl font-extrabold leading-26 mb-6">
					<span className="text-stroke dark:text-stroke-white text-white dark:text-gray-800">I&apos;m </span>
				...
				<div className="max-w-[420px] pb-8 text-base font-light">
					<p className=" mb-4">
						I am mostly focuses on Headless / Jamstack tech stack, but I have experience in other web dev
						areas too.
					</p>
					<p className=" mb-4">
						Feel free to{' '}
